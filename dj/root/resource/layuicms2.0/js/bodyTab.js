...
layui.define(["element","jquery"],function(exports){
	...
	Tab.prototype.render = function() {
		//显示左侧菜单
		var _this = this;
		$(".navBar ul").html('<li class="layui-nav-item layui-this"><a data-url="/index"><i class="layui-icon" data-icon=""></i><cite>首页</cite></a></li>').append(_this.navBar(dataStr)).height($(window).height()-210);
	...
	// 通过title删除tab
	Tab.prototype.deleteTab = function(title){
		var that = this;
		if(that.hasTab(title)==-1){
			layer.msg("窗口不存在，不需关闭。");
		}
